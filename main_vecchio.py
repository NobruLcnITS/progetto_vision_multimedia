...
if __name__ == '__main__':
    filename = r'Data\img\monete2.png'
    ...
    print(f'dimesioni immagine: ',img.shape)
    ...
    for i, cnt in enumerate(contours):
        ...
        #print(f'dimesioni immagine: {i}',target.shape)
    ...
    img3 = cv.drawContours(img, valid_contours, -1, c_green, 3)
